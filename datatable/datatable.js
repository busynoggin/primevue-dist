...
this.primevue.datatable = (function (utils, api, Paginator, VirtualScroller, vue, OverlayEventBus, Dropdown, Button, Ripple) {
    ...
    var script$3 = {
        name: 'TableBody',
        emits: ['rowgroup-toggle', 'row-click', 'row-dblclick', 'row-rightclick', 'row-touchend', 'row-keydown', 'row-mousedown', 'row-mouseover', 'row-mouseleave',
        ...
        methods: {
            ...
            onRowMouseLeave(event, rowData, rowIndex) {
                this.$emit('row-mouseleave', {originalEvent: event, data: rowData, index: rowIndex});
            },
    ...
    const _hoisted_3$1 = ["onMouseover", "onMouseleave", "onClick", "onDblclick", "onContextmenu", "onKeydown", "tabindex", "onDragstart", "onDragover"];
              ...
              return (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
                ...
                ($props.expandableRowGroups ? $options.isRowGroupExpanded(rowData): true)
                  ? (vue.openBlock(), vue.createElementBlock("tr", {
                      ...
                      onMouseover: $event => ($options.onRowMouseOver($event, rowData, $options.getRowIndex(index))),
                      onMouseleave: $event => ($options.onRowMouseLeave($event, rowData, $options.getRowIndex(index))),
    ...
    var script = {
        ...
        emits: ['value-change', 'update:first', 'update:rows', 'page', 'update:sortField', 'update:sortOrder', 'update:multiSortMeta', 'sort', 'filter', 'row-click', 'row-dblclick',
            ...
            'cell-edit-init', 'cell-edit-complete', 'cell-edit-cancel', 'update:editingRows', 'row-edit-init', 'row-edit-save', 'row-edit-cancel', 'row-mouseover', 'row-mouseleave', 'row-keydown'],
        props: {
            value: {
                type: Array,
                default: null
      ...
      return (vue.openBlock(), vue.createElementBlock("div", {
              ...
              vue.createElementVNode("table", {
                ...
                ($props.frozenValue)
                  ? (vue.openBlock(), vue.createBlock(_component_DTTableBody, {
                      ...
                      onRowMouseover: _cache[10] || (_cache[10] = $event => ($options.onRowMouseOver($event))),
                      onRowMouseleave: _cache[11] || (_cache[11] = $event => ($options.onRowMouseLeave($event))),
                      onRowDblclick: _cache[12] || (_cache[12] = $event => ($options.onRowDblClick($event))),
                      onRowRightclick: _cache[13] || (_cache[13] = $event => ($options.onRowRightClick($event))),
                      onRowTouchend: $options.onRowTouchEnd,
                      onRowKeydown: $options.onRowKeyDown,
                      onRowMousedown: $options.onRowMouseDown,
                      onRowDragstart: _cache[14] || (_cache[14] = $event => ($options.onRowDragStart($event))),
                      onRowDragover: _cache[15] || (_cache[15] = $event => ($options.onRowDragOver($event))),
                      onRowDragleave: _cache[16] || (_cache[16] = $event => ($options.onRowDragLeave($event))),
                      onRowDragend: _cache[17] || (_cache[17] = $event => ($options.onRowDragEnd($event))),
                      onRowDrop: _cache[18] || (_cache[18] = $event => ($options.onRowDrop($event))),
                      onRowToggle: _cache[19] || (_cache[19] = $event => ($options.toggleRow($event))),
                      onRadioChange: _cache[20] || (_cache[20] = $event => ($options.toggleRowWithRadio($event))),
                      onCheckboxChange: _cache[21] || (_cache[21] = $event => ($options.toggleRowWithCheckbox($event))),
                      onCellEditInit: _cache[22] || (_cache[22] = $event => ($options.onCellEditInit($event))),
                      onCellEditComplete: _cache[23] || (_cache[23] = $event => ($options.onCellEditComplete($event))),
                      onCellEditCancel: _cache[24] || (_cache[24] = $event => ($options.onCellEditCancel($event))),
                      onRowEditInit: _cache[25] || (_cache[25] = $event => ($options.onRowEditInit($event))),
                      onRowEditSave: _cache[26] || (_cache[26] = $event => ($options.onRowEditSave($event))),
                      onRowEditCancel: _cache[27] || (_cache[27] = $event => ($options.onRowEditCancel($event))),
                ...
                vue.createVNode(_component_DTTableBody, {
                  ...
                  onRowMouseover: _cache[29] || (_cache[29] = $event => ($options.onRowMouseOver($event))),
                  onRowMouseleave: _cache[30] || (_cache[30] = $event => ($options.onRowMouseLeave($event))),
                  onRowDblclick: _cache[31] || (_cache[31] = $event => ($options.onRowDblClick($event))),
                  onRowRightclick: _cache[32] || (_cache[32] = $event => ($options.onRowRightClick($event))),
                  onRowTouchend: $options.onRowTouchEnd,
                  onRowKeydown: $options.onRowKeyDown,
                  onRowMousedown: $options.onRowMouseDown,
                  onRowDragstart: _cache[33] || (_cache[33] = $event => ($options.onRowDragStart($event))),
                  onRowDragover: _cache[34] || (_cache[34] = $event => ($options.onRowDragOver($event))),
                  onRowDragleave: _cache[35] || (_cache[35] = $event => ($options.onRowDragLeave($event))),
                  onRowDragend: _cache[36] || (_cache[36] = $event => ($options.onRowDragEnd($event))),
                  onRowDrop: _cache[37] || (_cache[37] = $event => ($options.onRowDrop($event))),
                  onRowToggle: _cache[38] || (_cache[38] = $event => ($options.toggleRow($event))),
                  onRadioChange: _cache[39] || (_cache[39] = $event => ($options.toggleRowWithRadio($event))),
                  onCheckboxChange: _cache[40] || (_cache[40] = $event => ($options.toggleRowWithCheckbox($event))),
                  onCellEditInit: _cache[41] || (_cache[41] = $event => ($options.onCellEditInit($event))),
                  onCellEditComplete: _cache[42] || (_cache[42] = $event => ($options.onCellEditComplete($event))),
                  onCellEditCancel: _cache[43] || (_cache[43] = $event => ($options.onCellEditCancel($event))),
                  onRowEditInit: _cache[44] || (_cache[44] = $event => ($options.onRowEditInit($event))),
                  onRowEditSave: _cache[45] || (_cache[45] = $event => ($options.onRowEditSave($event))),
                  onRowEditCancel: _cache[46] || (_cache[46] = $event => ($options.onRowEditCancel($event))),
                  editingMeta: $data.d_editingMeta,
                  onEditingMetaChange: $options.onEditingMetaChange,
        ...
        ($options.paginatorBottom)
          ? (vue.openBlock(), vue.createBlock(_component_DTPaginator, {
              ...
              onPage: _cache[47] || (_cache[47] = $event => ($options.onPage($event))),
              alwaysShow: $props.alwaysShowPaginator
            }, vue.createSlots({ _: 2 }, [
              (_ctx.$slots.paginatorstart)
                ? {
