...
export interface DataTableRowMouseLeaveEvent extends DataTableRowClickEvent { }

export interface DataTableRowMouseOverEvent extends DataTableRowClickEvent { }
...
export declare type DataTableEmits = {
    ...
    /**
      * Callback to invoke when a row is mouseover.
      * @param {DataTableRowMouseOverEvent} event - Custom row mouseover event.
      */
    'row-mouseover': (event: DataTableRowMouseOverEvent) => void;
    /**
      * Callback to invoke when a row is mouseleave.
      * @param {DataTableRowMouseLeaveEvent} event - Custom row mouseleave event.
      */
    'row-mouseleave': (event: DataTableRowMouseLeaveEvent) => void;
    /**
